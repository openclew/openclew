...
Le résultat minimum = un `doc/` avec au moins un ref (`doc/_*.md`), découvrable par `openclew peek`.
...
3. Crée un premier ref (`doc/_ARCHITECTURE.md`) avec les métadonnées détectées
4. Propose un premier ref (`doc/_ARCHITECTURE.md` ou similaire) basé sur ce qu'il a détecté
...
3. Créer les refs initiaux avec les métadonnées détectées
4. Proposer 1-3 refs pertinents selon le type de projet
