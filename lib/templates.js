...
function exampleLogContent() {
  const date = today();
  const ver = ocVersion();
  return `openclew@${ver} · date: ${date} · type: Doc · status: Done · category: Setup · keywords: [openclew, init, first-log]
...
- Set up openclew, filled in doc/_ARCHITECTURE.md with our project stack
