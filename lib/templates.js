...
function guideContent() {
  const date = today();
  const ver = ocVersion();
  return `openclew@${ver} · created: ${date} · updated: ${date} · type: Guide · status: Active · category: Documentation · keywords: [openclew, L1, L2, L3, index, living-doc, log]
...
6. After significant work: create or update living docs and logs directly
