...
const { guideContent, frameworkIntegrationContent, exampleRefdocContent, exampleLogContent, todoContent, today, ocVersion } = require("./templates");
...
async function main() {
  ...
  console.log("  1. Open doc/_ARCHITECTURE.md and describe YOUR project");
  console.log("     That's your first refdoc — the clew your future self will grab.\n");
