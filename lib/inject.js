...
**Format is mandatory.** Every doc you create or edit in \`doc/\` MUST have: line 1 metadata, \`<!-- L1_START -->\`/\`<!-- L1_END -->\` markers with \`**subject:**\` and \`**doc_brief:**\`, and \`<!-- L2_START -->\`/\`<!-- L2_END -->\` markers. Use \`npx openclew new\` or \`npx openclew log\` to generate the correct template — never create docs from scratch.
