...
- **No matching doc? Propose creating a refdoc** (not a log). Suggest \`npx openclew add ref "Title"\` to capture key information before writing code. Logs are for end-of-session summaries only.
