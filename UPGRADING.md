...
**Not in scope**: sub-header emojis.

---

## Limitations

### Repointing `related_docs` after moving files

If you move a file (e.g. `doc/_AUTH.md` → `doc/ref/_AUTH.md`), references in other docs break.
Use `openclew migrate --repoint <old-path> <new-path> [--write]` to update all references.
